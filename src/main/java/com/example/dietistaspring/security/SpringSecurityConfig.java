...
public class SpringSecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        return http.authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/usuario/busquedaNombre").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/comentarios/filter/betweenDate").hasAnyRole("DADMIN", "DIETISTA")
                        .requestMatchers(HttpMethod.GET, "/api/comentarios/filter/{id}/betweenDateDietista").hasAnyRole("DADMIN", "DIETISTA")
                        .requestMatchers(HttpMethod.GET, "/api/comentarios/filter/{id}/betweenDateClient").hasAnyRole("DADMIN", "DIETISTA", "CLIENTE")
